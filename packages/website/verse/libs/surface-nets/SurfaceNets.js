    ...
    for (x[1] = 0; x[1] < dims[1] - 1; ++x[1], ++n, m += 2)
      for (x[0] = 0; x[0] < dims[0] - 1; ++x[0], ++n, ++m) {
        ...
        for (var i = 0; i < 3; ++i) {
          ...
          // fix z-fighting
          // --------------
          // we use 1 voxel overlapping chunks so we ignore west (x=0) and north (z=0) edges
          // and allow their neighbours (west and north) to contribute them instead.
          if ((i === 0 && x[0] === 0) || (i === 2 && x[2] === 0)) {
            continue
          }
